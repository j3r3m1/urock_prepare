...
def classFactory(iface):  # pylint: disable=invalid-name
    """Load GenBuildVegVlayersPlugin class from file gen_buildveg_vlayers.

    :param iface: A QGIS interface instance.
    :type iface: QgsInterface
    """
    #
    from .gen_buildveg_vlayers import GenBuildVegVlayersPlugin
    return GenBuildVegVlayersPlugin()
